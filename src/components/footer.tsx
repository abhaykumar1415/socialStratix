			...
			<div className='container mx-auto'>
				<div className='flex flex-wrap justify-center gap-8 md:justify-between'>
					<div className='text-center md:text-left'>
						...
						<Typography color='white' className='mb-12 font-normal' placeholder={undefined}>
							Catalyze the prowess of Originators !!
						</Typography>
					...
					<div className='mt-8 w-full md:mt-0 md:w-auto'>
						...
						<div className='flex flex-col gap-2'>
							<Button color='white' className='flex items-center justify-center' placeholder={undefined}>
								<Image
									width={256}
									height={256}
