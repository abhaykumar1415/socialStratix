...
export function TestimonialCard({ img, feedback, client, title }: TestimonialCardProps) {
	return (
		<Card shadow={false} className='items-center text-center' placeholder={undefined}>
			<CardBody placeholder={undefined}>
				...
				<Typography variant='paragraph' className='mb-5 font-normal !text-gray-500' placeholder={undefined}>
					&quot;{feedback}&quot;
				</Typography>
			</CardBody>
		</Card>
